...
const Home = () => {
  ...
  return (
    <main className="home">
      <Loader />
      <div className="home-inner" id="hero">
        <div className="hero-section">
          ...
          <div className="hero-section-inner container">
            ...
            <h1 className="hero-section-inner__title">{y("hero.title")}</h1>

            <p className="hero-section-inner__text">
              <b>{y("hero.subtitle.1")}</b> {y("hero.subtitle.2")}
              <b> {y("hero.subtitle.3")}</b> {y("hero.subtitle.4")}
            </p>
